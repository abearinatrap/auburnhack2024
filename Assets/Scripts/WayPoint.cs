...
public class MissionWaypoint1 : MonoBehaviour, ILocationInteractable
{
    // Indicator icon
    public Image img;
    ...
    private void Update()
    {
        ...
        meter.text = (Mathf.Abs((int)Vector3.Distance(target.position, transform.position) / 30 - 2)).ToString() + "m";
    }
}